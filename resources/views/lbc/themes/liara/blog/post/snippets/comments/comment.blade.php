...
<div class="media {{ $class ?? 'mb-3' }}">
    ...
    <div class="media-body">
        ...
        <div class="small pl-2 d-flex">
            ...
            <a class="ml-auto btn btn-outline-primary btn-sm mt-1"
               onclick="this.innerHTML=this.innerHTML[0]==='R'?'Cancel reply':'Reply'" href="#collapseComment_{{ $loopIndex }}"
               data-toggle="collapse">Reply
            </a>
        </div>
