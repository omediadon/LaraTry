...
@section('page-header')
    <div class="page-header page-header-has-image d-flex align-items-center">
        <x-image src="liara/images/homepage/sunset.jpg" class="page-header-image animated fadeIn faster" />
        ...
        <div class="container">
            <div class="page-header-lead lead position-relative mb-5 mb-lg-0">
                ...
                <h1 class="page-header-title">
                    Create quickly and easily, something beautiful with Laravel Bootstrap Components </h1>

                <p>Build your website with a new components generation</p>

                <a class="btn btn-primary text-uppercase"
                   href="https://shop.zundel-webdesign.de/laravel-bootstrap-components-incl-themes">Purchase
                </a>
            </div>
        </div>
    </div>
