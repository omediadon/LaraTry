<div class="row row-1 mb-3 mb-lg-5 overflow-hidden">
    <div class="col-lg-7">
        <x-image class="row-1-image img-fluid rounded-lg mb-3 mb-lg-0 animated fadeIn faster" src="liara/images/homepage/guy.jpg"
                 :width="[635]" :height="[800]" fit="crop-center" />
    </div>
    ...
    <div class="col-lg-5 d-flex flex-column justify-content-center">
        ...
        <p class="mb-3">
            ...
            velit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia </p>
            ...
            <ul class="list-inline d-flex justify-content-between mb-0">
                @foreach($listInlineItems as $item)
                    <li class="list-inline-item pr-1 position-relative">
                        <x-card :all="$item" :overlay="true" class="shadow" :image="[
                'class' => 'rounded',
                'width' => [135],
                'height' => [160],
              ]" :body="[
