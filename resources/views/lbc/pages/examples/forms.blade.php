        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate="">
                    ...
                    <div class="mb-3">
                        <x-input name="email" :label="['text' => 'Email <span class=\'text-muted\'>(Optional)</span>']"
                                 type="email" placeholder="you@example.com" />
                    </div>

                    <div class="mb-3">
                        <x-input name="address" :label="['text' => 'Address']" placeholder="1234 Main St" />
                    </div>

                    <div class="mb-3">
                        <x-input name="address2" :label="['text' => 'Address 2 <span class=\'text-muted\'>(Optional)</span>']"
                                 placeholder="Apartment or suite" />
                    </div>

                    <div class="row">
                        <div class="col-md-5 mb-3">
                            <x-select class="custom-select d-block w-100" name="country" :label="[
                  'text' => 'Country'
                ]" :options="['Choose...', 'Germany']" />
                        </div>

                        <div class="col-md-4 mb-3">
                            <x-select class="custom-select d-block w-100" name="state" :label="[
                  'text' => 'State'
                ]" :options="['Choose...', 'Frankfurt']" />
                        </div>

                        <div class="col-md-3 mb-3">
                            <x-input name="zip" :label="['text' => 'Zip']" />
                        </div>
                    </div>

                    <hr class="mb-4">

                    <x-checkbox name="same-address" :group="['class' => 'mb-0']"
                                :label="['text' => 'Shipping address is the same as my billing address']" />

                    <x-checkbox name="save-info" :group="['class' => 'mb-0']"
                    ...
                    <div class="d-block my-3">
                        <x-radio name="paymentMethod" id="credit" :group="['class' => 'mb-0']"
                                 :label="['text' => 'Credit card']" />

                        <x-radio name="paymentMethod" id="debit" :group="['class' => 'mb-0']" :label="['text' => 'Debit card']" />

                        <x-radio name="paymentMethod" id="paypal" :group="['class' => 'mb-0']" :label="['text' => 'PayPal']" />
                    </div>

                    <div class="row">
                        <div class="col-md-6">
                            <x-input name="cc-name" help="Full name as displayed on card" :label="['text' => 'Name on card']" />
                        </div>

                        <div class="col-md-6">
                            <x-input name="cc-number" :label="['text' => 'Credit card number']" />
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-3">
                            <x-input name="cc-expiration" :label="['text' => 'Expiration']" />
                        </div>

                        <div class="col-md-3">
                            <x-input name="cc-cvv" :label="['text' => 'CVV']" />
                        </div>
                    </div>
