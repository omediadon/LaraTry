...
@section('page-content')
    <div class="container">
        <div class="p-4 p-md-5 mb-5 bg-lighter rounded-lg">
            ...
            <p class="lead">
                Since all components have been created in the Template Engine Blade, it is no longer necessary to edit completly
                HTML of component of Bootstrap. This saves a lot of time in development. If you still want to change the
                component, you only have to do this in one file and not in the whole project. All changes are automatically
                transferred throughout the project. Bootstrap updates will no longer be a problem for you. All new features are
                automatically updated. You just have to install the latest version of Lbc and your project is up to date. </p>

            <p class="lead">Convince yourself and look here:
                <a href="{{ route('examples', 'forms') }}">Examples</a>
            </p>
        </div>
...
&lt;/div&gt;
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <a href="https://laravel-bootstrap-components.com/downloads" class="btn btn-primary btn-lg shadow"
