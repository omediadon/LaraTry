...
@section('component-content')
    ...
    <p>In laravel is a pagination function already finished existing, if you use this, change the array's to laravel pagination
       objects:
        <a target="_blank" href=" https://laravel.com/docs/5.8/pagination">
            https://laravel.com/docs/5.8/pagination
        </a>
    </p>

    <!-- example-start-1 -->
    <x-pagination :current="4" :total="4" :next="[
    ...
    <!-- example-start-3 -->
    <x-pagination class="pagination-lg" :current="4" :total="4" :next="[
      'href' => url()->current() . '?page=3',
      'text' => 'Next'
    ]" :prev="[
      'href' => url()->current() . '?page=3',
    ...
    <!-- example-start-4 -->
    <x-pagination class="pagination-sm" :current="4" :total="4" :next="[
      'href' => url()->current() . '?page=3',
      'text' => 'Next'
    ]" :prev="[
      'href' => url()->current() . '?page=3',
