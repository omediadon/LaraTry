...
@section('component-content')
    ...
    <x-modal id="video-about-us" title="Modal with embed video">
        <x-slot name="body">
            ...
            <div class="text-muted mt-3">
                We are Unify a creative studio focusing on culture, luxury, editorial & art. Somewhere between sophistication and
                simplicity
            </div>
        </x-slot>
    ...
    <p>When modals become too long for the user’s viewport or device, they scroll independent of the page itself. Try the demo
       below to see what we mean.</p>
    ...
    <x-modal id="scrolling-long-content" title="Scrolling long content">
        <x-slot name="body">
            ...
            sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, Lorem
            ...
            Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, Lorem ipsum dolor sit
            ...
            consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra
            ...
            sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas
            nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet
