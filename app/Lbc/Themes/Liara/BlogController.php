...
class BlogController extends Controller{
	...
	public function __construct(){
		$posts          = file_get_contents(app_path('Lbc/Themes/Liara/DataExamples/Blog/Posts.json'));
		$comments       = file_get_contents(app_path('Lbc/Themes/Liara/DataExamples/Blog/Comments.json'));
	...
	public function send(Request $request){
		...
		if($validator->fails()){
			return redirect()
				->to(url()->previous() . '#currentComment')
		...
		return redirect()
			...
			->with('success', 'Ihre Email wurde erfolgreich versendet.');
	}
